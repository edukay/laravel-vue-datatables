            ...
            <div class="panel-body">
                <div class="well" v-if="creating.active">
                    <form action="#" class="form-horizontal" @submit.prevent="store">
                        <div v-for="column in response.updatable" class="form-group" :class="{'has-error': creating.errors[column]}">
                            <label :for="column" class="control-label col-md-3">{{ response.custom_columns[column] || column }}</label>
                            <div class="col-md-6">
                        ...
                        <tbody>
                            <tr v-for="record in filteredRecords">
                                <td v-if="canSelectItems">
                                    <input :value="record.id" v-model="selected" type="checkbox">
                                </td>
